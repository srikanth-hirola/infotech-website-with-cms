...
import { DelhiData } from "../../data/companies/SeoCompanies";
...
const allServiceData = DelhiData;

const SeoCompanyInDelhi = () => {
...
<meta name='description' content={allServiceData.metaDescription} data-rh="true" />
      ...
      <main className="main-wrapper">
        ...
        {/* about us section */}
        {/* why work with us */}
        <div className="section section-padding section-padding-ser bg-color-light  pb_lg--40 pb_md--20">
          <div className="container">
            <SectionTitle
              subtitle="Our Values"
        ...
        <div className="section section-padding section-padding-ser ">
          <div className="container">
...
export default SeoCompanyInDelhi;
