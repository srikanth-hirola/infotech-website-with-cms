...
import  { ChennaiData } from "../../data/companies/SeoCompanies";
...
const allServiceData = ChennaiData;

const SeoCompanyInChennai = () => {
...
<meta name='description' content={allServiceData.metaDescription} data-rh="true" />
   ...
   <div className="section section-padding section-padding-ser pb--70">
          <SectionTitle
            subtitle="Process"
            title="Our Search Engine Optimzation Process "
...
export default SeoCompanyInChennai;
