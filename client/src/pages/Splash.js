            ...
            <main className="main-wrapper">
                ...
                <div className="section main-demo-area bg-color-light" id="splash-demo">
                                    ...
                                    <div className="single-demo">
                                        <Link to={`${process.env.PUBLIC_URL}/${slugify(data.title)}`}>
                                            <span className="thumb">
                                                <img src={`${process.env.PUBLIC_URL}${data.height_img}`} loading="lazy" alt={data.title} />
                                            </span>
                    ...
                    <ul className="shape-group list-unstyled">
                        <li className="shape-1"><img src={process.env.PUBLIC_URL + "/images/others/bubble-35.png"} loading="lazy" alt="Shape" /></li>
                        <li className="shape-2"><img src={process.env.PUBLIC_URL + "/images/others/line-4.png"} loading="lazy" alt="Shape" /></li>
                    </ul>
                </div>
                                    ...
                                    <div className="col-xl-4 col-md-6" key={data.id}>
                                        <div className="services-grid">
                                            <div className="thumbnail">
                                                <img src={process.env.PUBLIC_URL + data.icon} loading="lazy" alt="icon" />
                                            </div>
                ...
                <div className="section section-padding bg-color-light spalsh-why-choose" id="splash-why-choose">
                                    ...
                                    <div className="col-xl-4 col-lg-6" key={data.id}>
                                        <div className="why-buy-box">
                                            <div className="heading">
                                                <div className="icon">
                                                    <img src={process.env.PUBLIC_URL + data.icon} loading="lazy" alt="Thumb" />
                                                </div>
                                                <h5 className="title" dangerouslySetInnerHTML={{__html: data.title}}></h5>
                                            </div>
                                            <p>{data.para}</p>
                                    ...
                                    <a href="https://new.axilthemes.com/docs/abstrak-react/">
                                        <div className="inner">
                                            <div className="content">
                                                ...
                                                <div className="icon">
                                                    <img src={process.env.PUBLIC_URL + "/images/icon/icon-25.png"} loading="lazy" alt="Thumb" />
                                                </div>
                                                </div>
                                        ...
                                        <ul className="shape-group list-unstyled">
                                            <li className="shape-1"><img src={process.env.PUBLIC_URL + "/images/others/bubble-34.png"} loading="lazy" alt="Shape" /></li>
                                            <li className="shape-2"><img src={process.env.PUBLIC_URL + "/images/others/line-8.png"} loading="lazy" alt="Shape" /></li>
                                        </ul>
                                    </a>
                                </div>
                            </div>
                                ...
                                <div className="support-box support-ticket splash-hover-control">
                                    <a href="https://support.axilthemes.com/support/">
                                        ...
                                        <div className="content">
                                            ...
                                            <div className="icon">
                                                <img src={process.env.PUBLIC_URL + "/images/icon/icon-26.png"} loading="lazy" alt="Thumb" />
                                            </div>
                                            </div>
                    ...
                    <div className="line-shape">
                        <img src={process.env.PUBLIC_URL + "/images/others/line-6.png"} loading="lazy" alt="Line" />
                    </div>
                </div>
                <SplashCta />
                <SplashFooter />
