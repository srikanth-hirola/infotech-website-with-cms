    ...
    const columns = [
      {
      ...
      },
        {
          ...
          key: 'title',
          render: (text, record) => (
            <Link to={`/admin/news/edit/${record._id}`} style={{ display: 'block' }}>
              {text}
            </Link>
          ),
        ...
        },
        {
          ...
          dataIndex: 'Dimage',
          key: 'Dimage',
          render: (Dimage) => <img src={Dimage?.url} alt="Image" style={{ width: '50%', height: '100px', objectFit:'contain' }} />,
        },
        {
          title: 'Action',
          key: 'action',
          render: (text, record) => (
            <Space size="middle">
              <EditButton path={`/admin/news/edit/${record._id}`} />
              <DeleteButton
                id={record._id}
                setLoading={setLoading}
                endpoint={`admin/news/${record._id}`}
