...
const TeamOne = (teamData) => {
  ...
  const [pagefound, setPageFound] = useState('');
    ...
    console.log("bangaloreTeam",bangaloreTeam)
    ...
    return (
        ...
        <div className="section-heading heading-light">
            <h2 className="title mb--50">Our Bangalore Team</h2>
          ...
          <Link to='/overseas-team' className="axil-btn btn-large btn-fill-primary  view-team">View Our Overseas Team </Link>
          </div>
